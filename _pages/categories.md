...
<div class="category-section" data-category="{{ cat.name | slugify }}" data-title="{{ cat.name }}">
<h2 id="{{ cat.name | slugify }}" class="archive__subtitle">{{ cat.name }}</h2>
...
<div class="category-section" data-category="other" data-title="Other">
